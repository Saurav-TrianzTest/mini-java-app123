...
/**
 * Mini Java Application - Main Entry Point
 * Updated for Java 17 compatibility with modern features
 */
public class MiniApp {
    ...
    private void loadConfiguration() {
        ...
        if (configFile.exists()) {
            ...
            // Using try-with-resources for automatic resource management (modern Java feature)
